...
print(f'Список доступных языков: {LANGUAGES}')
language_translation = input('Введите язык на который хотите перевести текст: ')
...
translated = translator.translate(text_to_translate, dest=language_translation)

print(f"Переведённый текст: {translated.text}")